...
- cues: 3-5 short bold lines summarising the script. Every content word must already appear in the script. Never introduce a number, employer, or claim the script does not contain.
